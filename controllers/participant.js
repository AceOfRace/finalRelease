...
module.exports.displayparticipantList = (req, res, next) => {
    participant.find((err, participantList) => {
        ...
        else
        {
            ...
            res.render('participant/list', {title: 'Active Brackets', participantInfo: participantList}); 
        }
    });
}
...
module.exports.displayEditPage = (req, res, next) => {
    ...
    participant.findById(id, (err, participantToEdit) => {
        ...
        {
            //show the edit view
            res.render('participant/edit', {title: 'Edit participant', participant: participantToEdit})
        }
    });
}
